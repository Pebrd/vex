...
pub fn keybinds_bar(frame: &mut Frame, area: Rect, screen: &str, input_mode: &str) {
    let binds = match (screen, input_mode) {
        ("dashboard", _) => " [a]dd  [enter] open  [d]elete  [Ctrl+o] explorer  [?] help  [q]uit",
        ("issues", "none") => " [j/k] nav  [/] search  [O] browser  [Ctrl+o] explorer  [?] help  [q] back",
        ("issues", "edit") => " [Tab] field  [Ctrl+S] save  [Esc] cancel",
        ("prs", "none") => " [j/k] nav  [enter] detail  [O] browser  [Ctrl+o] explorer  [?] help  [q] back",
        ("notes", "none") => " [j/k] nav  [/] search  [?] help  [q] back",
        ("stats", _) | ("roadmap", _) => " [Ctrl+o] explorer  [?] help  [q] back",
        _ => "",
    };
