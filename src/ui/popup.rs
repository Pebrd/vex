...
#[allow(dead_code)]
pub fn confirm_dialog(frame: &mut Frame, area: Rect, title: &str, message: &str, theme: &Theme) {
...
pub fn merge_dialog(frame: &mut Frame, area: Rect, selected: usize, theme: &Theme) {
